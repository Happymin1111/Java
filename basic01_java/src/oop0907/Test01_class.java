...
import java.io.*;
import java.sql.*;
import java.util.Arrays;// 해당 클래스를 직접선언
...
/*
 ...
 ● Access Monifier 접근 제어, 접근 수정
  ->private      비공개. 클래스 내부에서만 접근 가능하다. 은닉할 수 있다.
  ->package      생략한다. 현재 package(oop0907)내에서만 접근가능하다
  ->protected    상속관계에 있는 클래스가 다른 패키지에 있는 경우 접근 가능(자식)
  ->public       공개 basic01_java 프로젝트 내에서는 모두 접근 가능.
...
public class Test01_class {
	...
	public static void main(String[] args) {
		...
		//기본자료형
		int a=3; //int는 메모리 4바이트 RAM의 stack 영역에 할당
